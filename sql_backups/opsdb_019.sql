...
CREATE SEQUENCE "public"."datasource_query_id_seq" INCREMENT 1 START 27 MAXVALUE 9223372036854775807 MINVALUE 1 CACHE 1;
...
CREATE SEQUENCE "public"."domain_name_id_seq" INCREMENT 1 START 1321 MAXVALUE 9223372036854775807 MINVALUE 1 CACHE 1;
...
CREATE SEQUENCE "public"."ip_v4_address_id_seq" INCREMENT 1 START 640 MAXVALUE 9223372036854775807 MINVALUE 1 CACHE 1;
...
CREATE SEQUENCE "public"."ip_v4_network_id_seq" INCREMENT 1 START 18 MAXVALUE 9223372036854775807 MINVALUE 1 CACHE 1;
...
CREATE SEQUENCE "public"."location_id_seq" INCREMENT 1 START 14 MAXVALUE 9223372036854775807 MINVALUE 1 CACHE 1;
...
CREATE SEQUENCE "public"."location_rack_id_seq" INCREMENT 1 START 4 MAXVALUE 9223372036854775807 MINVALUE 1 CACHE 1;
...
CREATE SEQUENCE "public"."machine_id_seq" INCREMENT 1 START 2367 MAXVALUE 9223372036854775807 MINVALUE 1 CACHE 1;
...
CREATE SEQUENCE "public"."machine_port_media_address_id_seq" INCREMENT 1 START 2801 MAXVALUE 9223372036854775807 MINVALUE 1 CACHE 1;
...
CREATE SEQUENCE "public"."machine_port_media_id_seq" INCREMENT 1 START 1464 MAXVALUE 9223372036854775807 MINVALUE 1 CACHE 1;
...
CREATE SEQUENCE "public"."operating_system_instance_id_seq" INCREMENT 1 START 2217 MAXVALUE 9223372036854775807 MINVALUE 1 CACHE 1;
...
CREATE SEQUENCE "public"."operation_system_id_seq" INCREMENT 1 START 7 MAXVALUE 9223372036854775807 MINVALUE 1 CACHE 1;
...
CREATE SEQUENCE "public"."udn_function_domain_id_seq" INCREMENT 1 START 1 MAXVALUE 9223372036854775807 MINVALUE 1 CACHE 1;
...
CREATE SEQUENCE "public"."udn_user_function_id_seq" INCREMENT 1 START 4 MAXVALUE 9223372036854775807 MINVALUE 1 CACHE 1;
...
CREATE SEQUENCE "public"."user_domain_id_seq" INCREMENT 1 START 1 MAXVALUE 9223372036854775807 MINVALUE 1 CACHE 1;
...
CREATE SEQUENCE "public"."vendor_part_id_seq" INCREMENT 1 START 1 MAXVALUE 9223372036854775807 MINVALUE 1 CACHE 1;
...
CREATE SEQUENCE "public"."web_site_api_id_seq" INCREMENT 1 START 2 MAXVALUE 9223372036854775807 MINVALUE 1 CACHE 1;
...
CREATE SEQUENCE "public"."web_site_page_id_seq" INCREMENT 1 START 34 MAXVALUE 9223372036854775807 MINVALUE 1 CACHE 1;
...
CREATE SEQUENCE "public"."web_site_page_widget_id_seq" INCREMENT 1 START 78 MAXVALUE 9223372036854775807 MINVALUE 1 CACHE 1;
...
CREATE SEQUENCE "public"."web_user_session_id_seq" INCREMENT 1 START 3 MAXVALUE 9223372036854775807 MINVALUE 1 CACHE 1;
...
CREATE SEQUENCE "public"."web_widget_id_seq" INCREMENT 1 START 57 MAXVALUE 9223372036854775807 MINVALUE 1 CACHE 1;
...
INSERT INTO "public"."web_site_page_widget" VALUES ('43', '20', '45', 'body', '40', 'Network Page', '{"base_list_example": "__widget.network_list"}', null);
INSERT INTO "public"."web_site_page_widget" VALUES ('19', '12', '19', 'body', '40', 'Chat Page', '{"chat_list": "__widget.chat_list"}', null);
INSERT INTO "public"."web_site_page_widget" VALUES ('44', '20', '43', 'network_list', '20', 'Network List', '{"table_rows": "__get.data.network_rows"}', null);
INSERT INTO "public"."web_site_page_widget" VALUES ('1', '1', '1', 'base_page', '0', 'Base Page', '{"title": "OpsDB",  "count_mail": "15", "welcome": "Control Everything", "side_nav_bar": "__widget.side_nav_bar", "count_notify": "7", "list_of_things": "__widget.list_of_things", "breadcrumb_area": "__widget.breadcrumb_area", "footer": "&copy; 2016. <a href=\"#\" class=\"navbar-link\">Ops DB</a> by <a href=\"http://opsdb.com/\" class=\"navbar-link\">Geoff Howland</a>", "body": "__widget.body", "user_name_full": "Geoff Howland", "page_name": "__get.web_site_page.name"}
', null);
INSERT INTO "public"."web_site_page_widget" VALUES ('45', '20', '44', 'network_list_row', '10', 'Network List Row', '{}', '[
  [
    [
	"__query.14",
	"__iterate.__template.web_widget.html.__string_append.data.network_rows.__end_iterate"
    ],
    [
	"__get.data.network_rows",
	""
    ]
  ]
]
');
INSERT INTO "public"."web_site_page_widget" VALUES ('61', '26', '45', 'body', '40', 'Machine', '{"base_list_example": "__widget.machine_view"}', null);
INSERT INTO "public"."web_site_page_widget" VALUES ('49', '21', '48', 'network_view_item', '10', 'Network View Item', '{}', null);
INSERT INTO "public"."web_site_page_widget" VALUES ('47', '21', '46', 'body', '40', 'Network View Page', '{"base_view_example": "__get.data.network_view"}', null);
INSERT INTO "public"."web_site_page_widget" VALUES ('56', '24', '45', 'body', '40', 'Network View2', '{"base_list_example": "__widget.base_view2"}', null);
INSERT INTO "public"."web_site_page_widget" VALUES ('57', '24', '54', 'base_view2', '30', 'Base View2', '{"primary_content": "__get.output.primary", "side_content_right": "__get.output.side_right"}', '[
  [
    [
      "__query.15.{id=(__get.param.id)}.__iterate.__set.temp.data.__end_iterate",
      "__input.[''name'',''address'',''cidr'',''alias'',''default_gateway_ip_v4_address_id'',''default_vlan_id''].__set.temp.list"
    ],
    [
      "__input.{name=''Network Name'',address=''Address'',cidr=''CIDR'',alias=''Location'',default_gateway_ip_v4_address_id=''Default Gateway'',default_vlan_id=''Default VLAN''}.__set.temp.map_label",
      "__input.{name=''icon-satellite-dish2'',address=''icon-rocket'',cidr=''icon-bucket'',alias=''icon-home2'',default_gateway_ip_v4_address_id=''icon-paperplane'',default_vlan_id=''icon-shield-check''}.__set.temp.map_icon"
    ],
    [
      "__template_string.(__get.base_widget.base_view2_primary_content.html).{title=''Network'',status=''ACTIVE'',icon=''icon-power2'',name=''Description'',info=''Information about Networks goes here.  It could be anything.''}.__set.output.primary",
      ""
    ],
    [
    ...
    [
      "__template_string.(__get.base_widget.base_view2_side_profile.html).{title=''Network'',rows=(__get.output.profile_rows)}.__set.output.side_right",
      ""
    ]
  ]
]
');
INSERT INTO "public"."web_site_page_widget" VALUES ('51', '23', '45', 'body', '40', 'Networks2 ', '{"base_list_example": "__widget.network_list2"}', null);
INSERT INTO "public"."web_site_page_widget" VALUES ('48', '21', '47', 'network_view', '20', 'Network View', '{}', '[
  [
    [
	"__query.15.{id=(__get.param.id)}",
	"__iterate.__template.web_widget.html.__string_append.data.network_view.__end_iterate"
    ],
    [
	"__get.data.network_view",
	""
    ]
  ]
]
');
INSERT INTO "public"."web_site_page_widget" VALUES ('50', '22', '49', 'login_base_page', '0', 'Login', '{}', null);
INSERT INTO "public"."web_site_page_widget" VALUES ('63', '27', '45', 'body', '40', 'OSes', '{"base_list_example": "__widget.item_list"}', null);
INSERT INTO "public"."web_site_page_widget" VALUES ('64', '27', '50', 'item_list', '30', 'OS List', '{"table_rows": "__get.output.rows", "table_headers": "__get.output.headers"}', '[
  [
    [
      "__function.render_table3.(__query.20).[''info'',''os_name'',''ip_v4_address'',''name''].{info=''OS Host Name'',os_name=''OS'',ip_v4_address=''IPv4'',name=''Interface''}.(__get.base_widget.base_list2_header.html).''output.headers''.(__get.base_widget.base_list2_row.html).''output.rows''.(__get.base_widget.base_list2_row_field.html)",
      ""
    ]
  ]
]');
INSERT INTO "public"."web_site_page_widget" VALUES ('52', '23', '50', 'network_list2', '20', 'Network List2', '{"table_rows": "__get.output.networks_rows", "table_headers": "__get.output.networks_header"}', '[
  [
    [
      "__function.render_table3.(__query.14).[''name'',''address'',''cidr'',''alias'',''default_gateway_ip_v4_address_id'',''default_vlan_id''].{name=''Network Name'',address=''Address'',cidr=''CIDR'',alias=''Location'',default_gateway_ip_v4_address_id=''Default Gateway'',default_vlan_id=''Default VLAN''}.(__get.base_widget.base_list2_header.html).''output.networks_header''.(__get.base_widget.base_list2_row.html).''output.networks_rows''.(__get.base_widget.base_list2_row_field.html)",
      "__get.output.networks_rows"
    ]
  ]
]');
INSERT INTO "public"."web_site_page_widget" VALUES ('60', '25', '50', 'machine_list', '30', 'Machine List', '{"table_rows": "__get.output.rows", "table_headers": "__get.output.headers"}', '[
  [
    [
      "__function.render_table3.(__query.18).[''info'',''model'',''location_name'',''location_alias'',''rack_name''].{info=''Machine Name'',model=''Hardware Model'',location_name=''Location'',location_alias=''Site Code'',rack_name=''Rack''}.(__get.base_widget.base_list2_header.html).''output.headers''.(__get.base_widget.base_list2_row.html).''output.rows''.(__get.base_widget.base_list2_row_field.html)",
      ""
    ]
  ]
]
');
INSERT INTO "public"."web_site_page_widget" VALUES ('46', '20', '42', 'base_page', '0', 'New Base Page', '{"title": "OpsDB",  "count_mail": "15", "welcome": "Control Everything", "side_nav_bar": "__widget.side_nav_bar", "count_notify": "''7''", "breadcrumb_area": "__widget.breadcrumb_area", "footer": "&copy; 2016. <a href=\"#\" class=\"navbar-link\">Ops DB</a> by <a href=\"http://opsdb.com/\" class=\"navbar-link\">Geoff Howland</a>", "body": "__widget.body", "page_name": "__get.web_site_page.title", "username": "__get.user.name", "web_site": "__get.web_site.name"}', null);
INSERT INTO "public"."web_site_page_widget" VALUES ('59', '25', '45', 'body', '40', 'Machines', '{"base_list_example": "__widget.machine_list"}', null);
INSERT INTO "public"."web_site_page_widget" VALUES ('62', '26', '54', 'machine_view', '30', 'Machine View', '{"primary_content": "__get.output.primary", "side_content_right": "__get.output.side_right"}', '[
  [
    [
      "__query.19.{id=(__get.param.id)}.__iterate.__set.temp.data.__end_iterate",
      "__input.[''info'',''model'',''location_name'',''location_alias'',''rack_name''].__set.temp.list"
    ],
    [
      "__input.{info=''Machine Name'',model=''Hardware Model'',location_name=''Location'',location_alias=''Site Code'',rack_name=''Rack''}.__set.temp.map_label",
      "__input.{info=''icon-server'',model=''icon-hammer-wrench'',location_name=''icon-map4'',location_alias=''icon-direction'',rack_name=''icon-archive''}.__set.temp.map_icon"
    ],
    [
      "__template_string.(__get.base_widget.base_view2_primary_content.html).{title=''Machine'',status=''ACTIVE'',icon=''icon-power2'',name=''Description'',info=''Information about the machine.  Anything could be here.''}.__set.output.primary",
      ""
    ],
    [
      "__get.temp.list.__iterate.__set.temp.name.__template_string.(__get.base_widget.base_view2_side_profile_row.html).{label=(__get.temp.map_label.(__get.temp.name)),value=(__get.temp.data.(__get.temp.name)),icon=(__get.temp.map_icon.(__get.temp.name))}.__string_append.output.profile_rows.__end_iterate",
...
INSERT INTO "public"."web_site_page_widget" VALUES ('65', '28', '45', 'body', '40', 'OS', '{"base_list_example": "__widget.item_view"}', null);
INSERT INTO "public"."web_site_page_widget" VALUES ('66', '28', '54', 'item_view', '30', 'OS View', '{"primary_content": "__get.output.primary", "side_content_right": "__get.output.side_right"}', '[
  [
    [
      "__query.21.{id=(__get.param.id)}.__iterate.__set.temp.data.__end_iterate",
      "__input.[''info'',''os_name'',''ip_v4_address'',''name''].__set.temp.list"
    ],
    [
      "__input.{info=''OS Host Name'',os_name=''OS'',ip_v4_address=''IPv4'',name=''Interface''}.__set.temp.map_label",
      "__input.{info=''icon-server'',os_name=''icon-database'',ip_v4_address=''icon-home9'',name=''icon-download''}.__set.temp.map_icon"
    ],
    [
      "__template_string.(__get.base_widget.base_view2_primary_content.html).{title=''OS Instance'',status=''ACTIVE'',icon=''icon-shutter'',name=''Description'',info=''Information about the OS Instance.  Anything could be here.  Absolutely anything.''}.__set.output.primary",
      ""
    ],
    [
      "__get.temp.list.__iterate.__set.temp.name.__template_string.(__get.base_widget.base_view2_side_profile_row.html).{label=(__get.temp.map_label.(__get.temp.name)),value=(__get.temp.data.(__get.temp.name)),icon=(__get.temp.map_icon.(__get.temp.name))}.__string_append.output.profile_rows.__end_iterate",
    ...
    [
      "__template_string.(__get.base_widget.base_view2_side_profile.html).{title=''OS Instance'',rows=(__get.output.profile_rows)}.__set.output.side_right",
      ""
    ]
  ]
]
');
INSERT INTO "public"."web_site_page_widget" VALUES ('67', '29', '45', 'body', '40', 'Web Site Pages', '{"base_list_example": "__widget.item_list"}', null);
INSERT INTO "public"."web_site_page_widget" VALUES ('68', '29', '50', 'item_list', '30', 'Web Site Page List', '{"table_rows": "__get.output.rows", "table_headers": "__get.output.headers"}', '[
  [
    [
      "__function.render_table3.(__query.22).[''name'',''title'',''info'',''web_site_name''].{name=''Page Path'',title=''Title'',info=''Info'',web_site_name=''Web Site''}.(__get.base_widget.base_list2_header.html).''output.headers''.(__get.base_widget.base_list2_row.html).''output.rows''.(__get.base_widget.base_list2_row_field.html)",
      ""
    ]
  ]
]');
INSERT INTO "public"."web_site_page_widget" VALUES ('69', '30', '45', 'body', '40', 'Web Site Page', '{"base_list_example": "__widget.item_view"}', null);
INSERT INTO "public"."web_site_page_widget" VALUES ('71', '31', '45', 'body', '40', 'Web Site Page Widgets', '{"base_list_example": "__widget.item_list"}', null);
INSERT INTO "public"."web_site_page_widget" VALUES ('70', '30', '54', 'item_view', '30', 'Web Site Page View', '{"primary_content": "__get.output.primary", "side_content_right": "__get.output.side_right"}', '[
  [
    [
      "__query.23.{id=(__get.param.id)}.__iterate.__set.temp.data.__end_iterate",
      "__input.[''name'',''title'',''info'',''web_site_name''].__set.temp.list"
    ],
    [
      "__input.{name=''Page Path'',title=''Title'',info=''Info'',web_site_name=''Web Site''}.__set.temp.map_label",
      "__input.{name=''icon-home9'',title=''icon-quill2'',info=''icon-image2'',web_site_name=''icon-city''}.__set.temp.map_icon"
    ],
    [
      "__template_string.(__get.base_widget.base_view2_primary_content.html).{title=''OS Instance'',status=''ACTIVE'',icon=''icon-shutter'',name=''Description'',info=''Information about the Web Site Page.  Anything could be here.  Absolutely anything.  Like this.''}.__set.output.primary",
      ""
    ],
    [
      "__get.temp.list.__iterate.__set.temp.name.__template_string.(__get.base_widget.base_view2_side_profile_row.html).{label=(__get.temp.map_label.(__get.temp.name)),value=(__get.temp.data.(__get.temp.name)),icon=(__get.temp.map_icon.(__get.temp.name))}.__string_append.output.profile_rows.__end_iterate",
    ...
    [
      "__template_string.(__get.base_widget.base_view2_side_profile.html).{title=''Web Site Page'',rows=(__get.output.profile_rows)}.__set.output.side_right",
      ""
    ]
  ]
]
...
');
INSERT INTO "public"."web_site_page_widget" VALUES ('72', '31', '50', 'item_list', '30', 'Web Site Page Widget List', '{"table_rows": "__get.output.rows", "table_headers": "__get.output.headers"}', '[
  [
    [
      "__function.render_table3.(__query.24).[''name'',''priority'',''info'',''data_json'',''page_name'',''page_title'',''widget_name''].{name=''Name'',priority=''Priority'',info=''Info'',data_json=''Template Data'',page_name=''Page Path'',page_title=''Title'',widget_name=''Widget''}.(__get.base_widget.base_list2_header.html).''output.headers''.(__get.base_widget.base_list2_row.html).''output.rows''.(__get.base_widget.base_list2_row_field.html)",
      ""
    ]
  ]
]');
INSERT INTO "public"."web_site_page_widget" VALUES ('73', '32', '45', 'body', '40', 'Web Site Page Widget', '{"base_list_example": "__widget.item_view"}', null);
INSERT INTO "public"."web_site_page_widget" VALUES ('74', '32', '54', 'item_view', '30', 'Web Site Page Widget View', '{"primary_content": "__get.output.primary", "side_content_right": "__get.output.side_right"}', '[
  [
    [
      "__query.25.{id=(__get.param.id)}.__iterate.__set.temp.data.__end_iterate",
      "__input.[''name'',''priority'',''info'',''page_name'',''page_title'',''widget_name''].__set.temp.list"
    ],
    [
      "__input.{name=''Name'',priority=''Priority'',info=''Info'',page_name=''Page Path'',page_title=''Title'',widget_name=''Widget''}.__set.temp.map_label",
      "__input.{name=''icon-brush'',priority=''icon-megaphone'',info=''icon-book2'',page_name=''icon-library2'',page_title=''icon-file-text'',widget_name=''icon-cog2''}__set.temp.map_icon"
    ],
    [
      "__template_string.(__get.base_widget.base_view2_primary_content.html).{title=''Web Site Page Widget'',status=''ACTIVE'',icon=''icon-shutter'',name=''Description'',info=''Information about the Web Site Page Widget.  Anything could be here.  Absolutely anything.  Like this.  But not like this.''}.__set.output.primary",
      ""
    ],
    [
      "__get.temp.list.__iterate.__set.temp.name.__template_string.(__get.base_widget.base_view2_side_profile_row.html).{label=(__get.temp.map_label.(__get.temp.name)),value=(__get.temp.data.(__get.temp.name)),icon=(__get.temp.map_icon.(__get.temp.name))}.__string_append.output.profile_rows.__end_iterate",
    ...
    [
      "__template_string.(__get.base_widget.base_view2_side_profile.html).{title=''Page Widget'',rows=(__get.output.profile_rows)}.__set.output.side_right",
      ""
    ]
  ]
]');
INSERT INTO "public"."web_site_page_widget" VALUES ('75', '33', '45', 'body', '40', 'Web Widgets', '{"base_list_example": "__widget.item_list"}', null);
INSERT INTO "public"."web_site_page_widget" VALUES ('77', '34', '45', 'body', '40', 'Web Widget', '{"base_list_example": "__widget.item_view"}', null);
INSERT INTO "public"."web_site_page_widget" VALUES ('76', '33', '50', 'item_list', '30', 'Web Widget List', '{"table_rows": "__get.output.rows", "table_headers": "__get.output.headers"}', '[
  [
    [
      "__function.render_table3.(__query.26).[''name'',''info'',''path'',''type_name'',''theme_name''].{name=''Name'',info=''Info'',path=''Path'',type_name=''Widget Type'',theme_name=''Theme''}.(__get.base_widget.base_list2_header.html).''output.headers''.(__get.base_widget.base_list2_row.html).''output.rows''.(__get.base_widget.base_list2_row_field.html)",
      ""
    ]
  ]
]
...
INSERT INTO "public"."datasource_query" VALUES ('17', '1', 'Web Widgets', 'SELECT * FROM web_widget', null, null);
INSERT INTO "public"."datasource_query" VALUES ('23', '1', 'Get Web Site Page', 'SELECT web_site_page.*, ws."name" AS web_site_name, ws."id" AS web_site_id FROM web_site_page JOIN web_site ws ON ws.id = web_site_id WHERE web_site_id = 1 AND web_site_page.id = {{id}}', '{"id": "int"}', null);
INSERT INTO "public"."datasource_query" VALUES ('9', '1', 'Web Widget', 'SELECT * FROM web_widget WHERE id = {{id}}', '{"id": "int"}', null);
INSERT INTO "public"."datasource_query" VALUES ('18', '1', 'Get Machines', 'SELECT machine.*, vp.model, rack.name AS rack_name, location.name as location_name, location.alias as location_alias FROM machine JOIN vendor_part vp ON vp.id = vendor_part_id JOIN location_rack rack ON rack.id = location_rack_id JOIN location ON location.id = rack.location_id', null, null);
INSERT INTO "public"."datasource_query" VALUES ('19', '1', 'Get Machine', 'SELECT machine.*, vp.model, rack.name AS rack_name, location.name as location_name, location.alias as location_alias FROM machine JOIN vendor_part vp ON vp.id = vendor_part_id JOIN location_rack rack ON rack.id = location_rack_id JOIN location ON location.id = rack.location_id WHERE machine.id = {{id}}', '{"id": "int"}', null);
INSERT INTO "public"."datasource_query" VALUES ('20', '1', 'Get OS Instances', 'SELECT osi.*, os.name AS os_name, ipv4a.address AS ip_v4_address, mpm."name" 
	...
	LEFT JOIN machine_port_media mpm ON mpm.id = osia.machine_port_media_id', null, null);
INSERT INTO "public"."datasource_query" VALUES ('24', '1', 'Get Web Site Page Widgets', 'SELECT wspw.*, wsp.name as page_name, wsp.title as page_title, ww.name as widget_name FROM web_site_page_widget wspw JOIN web_site_page wsp ON wsp.id = wspw.web_site_page_id JOIN web_widget ww ON ww.id = wspw.web_widget_id ORDER BY web_site_page_id,priority', null, null);
INSERT INTO "public"."datasource_query" VALUES ('21', '1', 'Get OS Machine', 'SELECT osi.*, os.name AS os_name, ipv4a.address AS ip_v4_address, mpm."name" 
	...
	WHERE osi.id = {{id}}', '{"id": "int"}', null);
INSERT INTO "public"."datasource_query" VALUES ('22', '1', 'Get Web Site Pages', 'SELECT web_site_page.*, ws."name" AS web_site_name, ws."id" AS web_site_id FROM web_site_page JOIN web_site ws ON ws.id = web_site_id WHERE web_site_id = 1', null, null);
INSERT INTO "public"."datasource_query" VALUES ('14', '1', 'OpsDB Networks', 'SELECT ip_v4_network.*, ip_v4_address.address, location.alias FROM ip_v4_network JOIN ip_v4_address ON ip_v4_address.id = ip_v4_address_id JOIN location ON location.id = location_id', null, null);
INSERT INTO "public"."datasource_query" VALUES ('15', '1', 'OpsDB Single Network', 'SELECT ip_v4_network.*, ip_v4_address.address, location.alias FROM ip_v4_network JOIN ip_v4_address ON ip_v4_address.id = ip_v4_address_id JOIN location ON location.id = location_id WHERE ip_v4_network.id = {{id}}', '{"id": "int"}', null);
INSERT INTO "public"."datasource_query" VALUES ('27', '1', 'Get Web Widget', 'SELECT ww.*, wwt.name as type_name, wwth.name as theme_name FROM web_widget ww JOIN web_widget_type wwt ON wwt.id = ww.web_widget_type_id JOIN web_widget_theme wwth ON wwth.id = ww.web_widget_theme_id WHERE ww.id = {{id}}', '{"id": "int"}', null);
INSERT INTO "public"."datasource_query" VALUES ('25', '1', 'Get Web Site Page Widget', 'SELECT wspw.*, wsp.name as page_name, wsp.title as page_title, ww.name as widget_name FROM web_site_page_widget wspw JOIN web_site_page wsp ON wsp.id = wspw.web_site_page_id JOIN web_widget ww ON ww.id = wspw.web_widget_id WHERE wspw.id = {{id}}', '{"id": "int"}', null);
INSERT INTO "public"."datasource_query" VALUES ('16', '1', 'Get Web User Session by Username', 'SELECT web_user_session.name as session FROM web_user_session JOIN "user" ON "user".id = user_id WHERE "user".name = ''{{username}}''', '{"username": "string"}', null);
INSERT INTO "public"."datasource_query" VALUES ('26', '1', 'Get Web Widgets', 'SELECT ww.*, wwt.name as type_name, wwth.name as theme_name FROM web_widget ww JOIN web_widget_type wwt ON wwt.id = ww.web_widget_type_id JOIN web_widget_theme wwth ON wwth.id = ww.web_widget_theme_id', null, null);
COMMIT;
...
<div class="page-header page-header-inverse">
    ...
    <div class="navbar navbar-inverse navbar-transparent">
        <div class="navbar-header">
            <!--<a class="navbar-brand" href="index.html"><img src="assets/images/logo_light.png" alt=""></a>-->
            <a class="navbar-brand" href="index.html" style="font-size: 1.5em;"><i style="font-size: 1.5em;" class="icon-pyramid2"></i> OpsDB</a>
    ...
    <div class="page-header-content">
        <div class="page-title">
            <h4>OpsDB - Floor 40 VLANs - {{index .Map "page_name"}}</h4>
        </div>
...
INSERT INTO "public"."web_widget" VALUES ('44', '1', '7', 'Network List Row', 'template/base/base_list_row.html', null, '<tr>
    <td><a href="network?id={{index .Map "id"}}">{{index .Map "name"}}</a></td>
...
<!-- /detailed task -->
', null);
INSERT INTO "public"."web_widget" VALUES ('50', '1', '3', 'base_list2', 'template/base/base_list2.html', null, '
<!-- Column selectors -->
<div class="panel panel-flat">
    <div class="panel-heading">
        <h5 class="panel-title">One Sansome - 40th Floor Networks</h5>
...
INSERT INTO "public"."web_site_page" VALUES ('2', '1', '/index.html', '1', 'OpsDB', null, null, null, 't');
INSERT INTO "public"."web_site_page" VALUES ('21', '1', '/network', '46', 'Network View', null, null, null, 't');
INSERT INTO "public"."web_site_page" VALUES ('20', '1', '/networks', '46', 'Network List', null, null, null, 't');
INSERT INTO "public"."web_site_page" VALUES ('22', '1', '/login', '50', 'Login', null, null, null, 't');
INSERT INTO "public"."web_site_page" VALUES ('23', '1', '/networks2', '46', 'Network List2', null, null, null, 't');
INSERT INTO "public"."web_site_page" VALUES ('24', '1', '/network2', '46', 'Network View2', null, null, null, 't');
INSERT INTO "public"."web_site_page" VALUES ('25', '1', '/machines', '46', 'Machine List', null, null, null, 't');
INSERT INTO "public"."web_site_page" VALUES ('26', '1', '/machine', '46', 'Machine View', null, null, null, 't');
INSERT INTO "public"."web_site_page" VALUES ('27', '1', '/oses', '46', 'OS List', null, null, null, 't');
INSERT INTO "public"."web_site_page" VALUES ('28', '1', '/os', '46', 'OS View', null, null, null, 't');
INSERT INTO "public"."web_site_page" VALUES ('29', '1', '/web_site_pages', '46', 'Web Site Pages', null, null, null, 't');
INSERT INTO "public"."web_site_page" VALUES ('30', '1', '/web_site_page', '46', 'Web Site Page', null, null, null, 't');
INSERT INTO "public"."web_site_page" VALUES ('31', '1', '/web_site_page_widgets', '46', 'Web Site Page Widgets', null, null, null, 't');
INSERT INTO "public"."web_site_page" VALUES ('32', '1', '/web_site_page_widget', '46', 'Web Site Page Widget', null, null, null, 't');
INSERT INTO "public"."web_site_page" VALUES ('33', '1', '/web_widgets', '46', 'Web Widgets', null, null, null, 't');
INSERT INTO "public"."web_site_page" VALUES ('34', '1', '/web_widget', '46', 'Web Widget', null, null, null, 't');
COMMIT;
...
CREATE TABLE "public"."udn_stored_function" (
	"id" int4 NOT NULL DEFAULT nextval('udn_user_function_id_seq'::regclass),
	"name" varchar(512) NOT NULL COLLATE "default",
...
CREATE TABLE "public"."web_user_session" (
	"id" int8 NOT NULL DEFAULT nextval('web_user_session_id_seq'::regclass),
	"name" varchar(512) NOT NULL COLLATE "default",
	"user_id" int8,
...
CREATE TABLE "public"."user_domain" (
	"id" int4 NOT NULL DEFAULT nextval('user_domain_id_seq'::regclass),
	"name" varchar(512) COLLATE "default"
)
WITH (OIDS=FALSE);
...
CREATE TABLE "public"."web_site_api" (
	"id" int8 NOT NULL DEFAULT nextval('web_site_api_id_seq'::regclass),
	"web_site_id" int8 NOT NULL,
	"name" varchar(512) NOT NULL COLLATE "default",
	"udn_data_json" json
)
...
CREATE TABLE "public"."udn_stored_function_domain" (
	"id" int4 NOT NULL DEFAULT nextval('udn_function_domain_id_seq'::regclass),
	"name" varchar(512) NOT NULL COLLATE "default",
	"info" text COLLATE "default"
)
WITH (OIDS=FALSE);
...
CREATE TABLE "public"."vendor_part" (
	...
	"id" int4 NOT NULL DEFAULT nextval('vendor_part_id_seq'::regclass)
)
WITH (OIDS=FALSE);
...
ALTER SEQUENCE "public"."datasource_query_id_seq" RESTART 28 OWNED BY "datasource_query"."id";
ALTER SEQUENCE "public"."datasource_type_id_seq" RESTART 6 OWNED BY "datasource_type"."id";
ALTER SEQUENCE "public"."domain_name_id_seq" RESTART 1322 OWNED BY "domain_name"."id";
ALTER SEQUENCE "public"."ip_floating_id_seq" RESTART 2 OWNED BY "ip_virtual"."id";
ALTER SEQUENCE "public"."ip_v4_address_id_seq" RESTART 641 OWNED BY "ip_v4_address"."id";
ALTER SEQUENCE "public"."ip_v4_network_id_seq" RESTART 19 OWNED BY "ip_v4_network"."id";
...
ALTER SEQUENCE "public"."location_id_seq" RESTART 15 OWNED BY "location"."id";
ALTER SEQUENCE "public"."location_rack_id_seq" RESTART 5 OWNED BY "location_rack"."id";
...
ALTER SEQUENCE "public"."machine_id_seq" RESTART 2368 OWNED BY "machine"."id";
...
ALTER SEQUENCE "public"."machine_port_media_address_id_seq" RESTART 2802 OWNED BY "operating_system_instance_address"."id";
ALTER SEQUENCE "public"."machine_port_media_id_seq" RESTART 1465 OWNED BY "machine_port_media"."id";
...
ALTER SEQUENCE "public"."operating_system_instance_id_seq" RESTART 2218 OWNED BY "operating_system_instance"."id";
...
ALTER SEQUENCE "public"."operation_system_id_seq" RESTART 8 OWNED BY "operating_system"."id";
...
ALTER SEQUENCE "public"."udn_function_domain_id_seq" RESTART 2 OWNED BY "udn_stored_function_domain"."id";
...
ALTER SEQUENCE "public"."udn_user_function_id_seq" RESTART 5 OWNED BY "udn_stored_function"."id";
ALTER SEQUENCE "public"."user_contact_id_seq" RESTART 4 OWNED BY "user_contact"."id";
ALTER SEQUENCE "public"."user_domain_id_seq" RESTART 2 OWNED BY "user_domain"."id";
...
ALTER SEQUENCE "public"."vendor_part_id_seq" RESTART 2 OWNED BY "vendor_part"."id";
...
ALTER SEQUENCE "public"."web_site_api_id_seq" RESTART 3 OWNED BY "web_site_api"."id";
...
ALTER SEQUENCE "public"."web_site_page_id_seq" RESTART 35 OWNED BY "web_site_page"."id";
ALTER SEQUENCE "public"."web_site_page_widget_id_seq" RESTART 79 OWNED BY "web_site_page_widget"."id";
ALTER SEQUENCE "public"."web_user_session_id_seq" RESTART 4 OWNED BY "web_user_session"."id";
ALTER SEQUENCE "public"."web_widget_argument_id_seq" RESTART 4 OWNED BY "web_widget_argument"."id";
ALTER SEQUENCE "public"."web_widget_id_seq" RESTART 58 OWNED BY "web_widget"."id";
...
-- ----------------------------
CREATE UNIQUE INDEX  "web_site_id_key" ON "public"."web_site" USING btree("id" "pg_catalog"."int4_ops" ASC NULLS LAST);
...
-- ----------------------------
CREATE UNIQUE INDEX  "web_site_map_id_key" ON "public"."web_site_map" USING btree("id" "pg_catalog"."int4_ops" ASC NULLS LAST);
...
-- ----------------------------
CREATE UNIQUE INDEX  "web_widget_id_key" ON "public"."web_widget" USING btree("id" "pg_catalog"."int4_ops" ASC NULLS LAST);
...
-- ----------------------------
CREATE UNIQUE INDEX  "location_id_key" ON "public"."location" USING btree("id" "pg_catalog"."int4_ops" ASC NULLS LAST);
...
-- ----------------------------
CREATE UNIQUE INDEX  "web_site_page_id_key" ON "public"."web_site_page" USING btree("id" "pg_catalog"."int4_ops" ASC NULLS LAST);
...
-- ----------------------------
CREATE UNIQUE INDEX  "operating_system_instance_id_key" ON "public"."operating_system_instance" USING btree("id" "pg_catalog"."int8_ops" ASC NULLS LAST);
...
-- ----------------------------
ALTER TABLE "public"."udn_stored_function" ADD PRIMARY KEY ("id") NOT DEFERRABLE INITIALLY IMMEDIATE;
...
-- ----------------------------
ALTER TABLE "public"."web_user_session" ADD PRIMARY KEY ("id") NOT DEFERRABLE INITIALLY IMMEDIATE;
...
-- ----------------------------
ALTER TABLE "public"."user_domain" ADD PRIMARY KEY ("id") NOT DEFERRABLE INITIALLY IMMEDIATE;
...
-- ----------------------------
CREATE UNIQUE INDEX  "user_domain_id_key" ON "public"."user_domain" USING btree("id" "pg_catalog"."int4_ops" ASC NULLS LAST);

-- ----------------------------
--  Primary key structure for table web_site_api
-- ----------------------------
ALTER TABLE "public"."web_site_api" ADD PRIMARY KEY ("id") NOT DEFERRABLE INITIALLY IMMEDIATE;
...
-- ----------------------------
ALTER TABLE "public"."udn_stored_function_domain" ADD PRIMARY KEY ("id") NOT DEFERRABLE INITIALLY IMMEDIATE;
...
-- ----------------------------
CREATE UNIQUE INDEX  "udn_stored_function_domain_id_key" ON "public"."udn_stored_function_domain" USING btree("id" "pg_catalog"."int4_ops" ASC NULLS LAST);

-- ----------------------------
--  Foreign keys structure for table user
-- ----------------------------
ALTER TABLE "public"."user" ADD CONSTRAINT "user_user_domain_id_fkey" FOREIGN KEY ("user_domain_id") REFERENCES "public"."user_domain" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE;

-- ----------------------------
--  Foreign keys structure for table web_site
-- ----------------------------
ALTER TABLE "public"."web_site" ADD CONSTRAINT "web_site_login_user_domain_id_fkey" FOREIGN KEY ("login_user_domain_id") REFERENCES "public"."user_domain" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "public"."web_site" ADD CONSTRAINT "web_site_login_web_site_page_id_fkey" FOREIGN KEY ("login_web_site_page_id") REFERENCES "public"."web_site_page" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "public"."web_site" ADD CONSTRAINT "web_site_default_web_site_map_id_fkey" FOREIGN KEY ("default_web_site_map_id") REFERENCES "public"."web_site_map" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "public"."web_site" ADD CONSTRAINT "web_site_udn_stored_function_domain_id_fkey" FOREIGN KEY ("udn_stored_function_domain_id") REFERENCES "public"."udn_stored_function_domain" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE;

-- ----------------------------
--  Foreign keys structure for table web_site_page_widget
-- ----------------------------
ALTER TABLE "public"."web_site_page_widget" ADD CONSTRAINT "web_site_page_widget_web_site_page_id_fkey" FOREIGN KEY ("web_site_page_id") REFERENCES "public"."web_site_page" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "public"."web_site_page_widget" ADD CONSTRAINT "web_site_page_widget_web_widget_id_fkey" FOREIGN KEY ("web_widget_id") REFERENCES "public"."web_widget" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE;
...
-- ----------------------------
ALTER TABLE "public"."domain_name" ADD CONSTRAINT "domain_name_machine_id_fkey" FOREIGN KEY ("operating_system_instance_id") REFERENCES "public"."operating_system_instance" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE;
...
ALTER TABLE "public"."ip_v4_network" ADD CONSTRAINT "ip_v4_network_location_id_fkey" FOREIGN KEY ("location_id") REFERENCES "public"."location" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE;
...
ALTER TABLE "public"."ip_v6_network" ADD CONSTRAINT "ip_v6_network_location_id_fkey" FOREIGN KEY ("location_id") REFERENCES "public"."location" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE;
...
-- ----------------------------
ALTER TABLE "public"."udn_stored_function" ADD CONSTRAINT "udn_stored_function_udn_stored_function_domain_id_fkey" FOREIGN KEY ("udn_stored_function_domain_id") REFERENCES "public"."udn_stored_function_domain" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE;

-- ----------------------------
--  Foreign keys structure for table web_user_session
-- ----------------------------
ALTER TABLE "public"."web_user_session" ADD CONSTRAINT "web_user_session_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."user" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "public"."web_user_session" ADD CONSTRAINT "web_user_session_web_site_id_fkey" FOREIGN KEY ("web_site_id") REFERENCES "public"."web_site" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE;
