...
-- ----------------------------
--  Sequence structure for machine_ip_address_id_seq
-- ----------------------------
DROP SEQUENCE IF EXISTS "public"."machine_ip_address_id_seq";
CREATE SEQUENCE "public"."machine_ip_address_id_seq" INCREMENT 1 START 1 MAXVALUE 9223372036854775807 MINVALUE 1 CACHE 1;
ALTER TABLE "public"."machine_ip_address_id_seq" OWNER TO "postgres";

-- ----------------------------
--  Sequence structure for machine_type_class_id_seq
-- ----------------------------
DROP SEQUENCE IF EXISTS "public"."machine_type_class_id_seq";
CREATE SEQUENCE "public"."machine_type_class_id_seq" INCREMENT 1 START 6 MAXVALUE 9223372036854775807 MINVALUE 1 CACHE 1;
...
-- ----------------------------
--  Table structure for machine_ip_address
-- ----------------------------
DROP TABLE IF EXISTS "public"."machine_ip_address";
CREATE TABLE "public"."machine_ip_address" (
	"id" int8 NOT NULL DEFAULT nextval('machine_ip_address_id_seq'::regclass),
	"ip_v4_address_id" int8,
	"ip_v6_address_id" int8
)
WITH (OIDS=FALSE);
ALTER TABLE "public"."machine_ip_address" OWNER TO "postgres";
...
ALTER SEQUENCE "public"."machine_ip_address_id_seq" RESTART 2 OWNED BY "machine_ip_address"."id";
ALTER SEQUENCE "public"."machine_type_class_id_seq" RESTART 7 OWNED BY "machine_type_class"."id";
...
-- ----------------------------
--  Primary key structure for table machine_ip_address
-- ----------------------------
ALTER TABLE "public"."machine_ip_address" ADD PRIMARY KEY ("id") NOT DEFERRABLE INITIALLY IMMEDIATE;
...
-- ----------------------------
--  Foreign keys structure for table machine_ip_address
-- ----------------------------
ALTER TABLE "public"."machine_ip_address" ADD CONSTRAINT "machine_ip_address_ip_v4_address_id_fkey" FOREIGN KEY ("ip_v4_address_id") REFERENCES "public"."ip_v4_address" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "public"."machine_ip_address" ADD CONSTRAINT "machine_ip_address_ip_v6_address_id_fkey" FOREIGN KEY ("ip_v6_address_id") REFERENCES "public"."ip_v6_address" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE;
