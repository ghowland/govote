...
CREATE SEQUENCE "public"."machine_part_type_id_seq" INCREMENT 1 START 5 MAXVALUE 9223372036854775807 MINVALUE 1 CACHE 1;
...
CREATE SEQUENCE "public"."machine_port_media_type_id_seq" INCREMENT 1 START 1 MAXVALUE 9223372036854775807 MINVALUE 1 CACHE 1;
...
-- ----------------------------
--  Sequence structure for machine_type_class_id_seq
-- ----------------------------
DROP SEQUENCE IF EXISTS "public"."machine_type_class_id_seq";
CREATE SEQUENCE "public"."machine_type_class_id_seq" INCREMENT 1 START 7 MAXVALUE 9223372036854775807 MINVALUE 1 CACHE 1;
ALTER TABLE "public"."machine_type_class_id_seq" OWNER TO "postgres";

-- ----------------------------
--  Sequence structure for machine_type_id_seq
-- ----------------------------
DROP SEQUENCE IF EXISTS "public"."machine_type_id_seq";
CREATE SEQUENCE "public"."machine_type_id_seq" INCREMENT 1 START 1 MAXVALUE 9223372036854775807 MINVALUE 1 CACHE 1;
ALTER TABLE "public"."machine_type_id_seq" OWNER TO "postgres";

-- ----------------------------
--  Sequence structure for operation_system_id_seq
-- ----------------------------
DROP SEQUENCE IF EXISTS "public"."operation_system_id_seq";
CREATE SEQUENCE "public"."operation_system_id_seq" INCREMENT 1 START 3 MAXVALUE 9223372036854775807 MINVALUE 1 CACHE 1;
...
CREATE SEQUENCE "public"."web_site_page_widget_id_seq" INCREMENT 1 START 42 MAXVALUE 9223372036854775807 MINVALUE 1 CACHE 1;
...
CREATE SEQUENCE "public"."web_widget_id_seq" INCREMENT 1 START 41 MAXVALUE 9223372036854775807 MINVALUE 1 CACHE 1;
...
INSERT INTO "public"."web_site_page_widget" VALUES ('20', '12', '20', 'chat_list', '20', 'Chat', '{}', null);
...
-- ----------------------------
--  Table structure for ip_floating
-- ----------------------------
DROP TABLE IF EXISTS "public"."ip_floating";
CREATE TABLE "public"."ip_floating" (
...
WITH (OIDS=FALSE);
ALTER TABLE "public"."ip_floating" OWNER TO "postgres";
...
-- ----------------------------
DROP TABLE IF EXISTS "public"."machine_type";
CREATE TABLE "public"."machine_type" (
	"id" int4 NOT NULL DEFAULT nextval('machine_type_id_seq'::regclass),
	"name" varchar(512) NOT NULL COLLATE "default",
	"info" text COLLATE "default",
	"machine_type_class_id" int4 NOT NULL,
	"manufacturer_id" int4,
	"manufacturer_model_id" int4
)
WITH (OIDS=FALSE);
ALTER TABLE "public"."machine_type" OWNER TO "postgres";

-- ----------------------------
--  Table structure for machine_type_class
-- ----------------------------
DROP TABLE IF EXISTS "public"."machine_type_class";
CREATE TABLE "public"."machine_type_class" (
	"id" int4 NOT NULL DEFAULT nextval('machine_type_class_id_seq'::regclass),
	"name" varchar(512) NOT NULL COLLATE "default",
	"info" text COLLATE "default"
)
WITH (OIDS=FALSE);
ALTER TABLE "public"."machine_type_class" OWNER TO "postgres";

-- ----------------------------
--  Records of machine_type_class
-- ----------------------------
BEGIN;
INSERT INTO "public"."machine_type_class" VALUES ('1', 'Physical Machine', null);
INSERT INTO "public"."machine_type_class" VALUES ('2', 'Virtual Machine', null);
INSERT INTO "public"."machine_type_class" VALUES ('3', 'Cloud Machine', null);
INSERT INTO "public"."machine_type_class" VALUES ('4', 'Physical Network Element', null);
INSERT INTO "public"."machine_type_class" VALUES ('5', 'Virtual Network Element', null);
INSERT INTO "public"."machine_type_class" VALUES ('6', 'Cloud Network Element', null);
INSERT INTO "public"."machine_type_class" VALUES ('7', 'Power Distribution', null);
COMMIT;

-- ----------------------------
--  Table structure for operation_system
-- ----------------------------
DROP TABLE IF EXISTS "public"."operation_system";
CREATE TABLE "public"."operation_system" (
	"id" int4 NOT NULL DEFAULT nextval('operation_system_id_seq'::regclass),
	"name" varchar(512) NOT NULL COLLATE "default",
	"info" text COLLATE "default",
	"operation_system_type_id" int4 NOT NULL
)
WITH (OIDS=FALSE);
ALTER TABLE "public"."operation_system" OWNER TO "postgres";

-- ----------------------------
--  Table structure for operation_system_type
-- ----------------------------
DROP TABLE IF EXISTS "public"."operation_system_type";
CREATE TABLE "public"."operation_system_type" (
	"id" int4 NOT NULL DEFAULT nextval('operation_system_id_seq'::regclass),
	"name" varchar(512) NOT NULL COLLATE "default",
	"info" text COLLATE "default"
)
WITH (OIDS=FALSE);
ALTER TABLE "public"."operation_system_type" OWNER TO "postgres";

-- ----------------------------
--  Records of operation_system_type
-- ----------------------------
BEGIN;
INSERT INTO "public"."operation_system_type" VALUES ('1', 'Host Operating System', null);
INSERT INTO "public"."operation_system_type" VALUES ('2', 'Virtual Machine Operating System', null);
INSERT INTO "public"."operation_system_type" VALUES ('3', 'Network Element Operating System', null);
COMMIT;
...
-- ----------------------------
--  Table structure for machine_part_type
-- ----------------------------
DROP TABLE IF EXISTS "public"."machine_part_type";
CREATE TABLE "public"."machine_part_type" (
	"id" int4 NOT NULL DEFAULT nextval('machine_part_type_id_seq'::regclass),
	"name" varchar(512) COLLATE "default",
	"info" text COLLATE "default"
)
WITH (OIDS=FALSE);
ALTER TABLE "public"."machine_part_type" OWNER TO "postgres";

-- ----------------------------
--  Records of machine_part_type
-- ----------------------------
BEGIN;
INSERT INTO "public"."machine_part_type" VALUES ('3', 'NIC', null);
INSERT INTO "public"."machine_part_type" VALUES ('2', 'Hard Drive: Rotating', null);
INSERT INTO "public"."machine_part_type" VALUES ('4', 'Hard Drive: SSD', null);
INSERT INTO "public"."machine_part_type" VALUES ('5', 'RAM', null);
COMMIT;
...
CREATE TABLE "public"."vendor_part" (
	...
	"machine_part_type_id" int4
)
WITH (OIDS=FALSE);
ALTER TABLE "public"."vendor_part" OWNER TO "postgres";

-- ----------------------------
--  Table structure for machine_port_media_address
-- ----------------------------
DROP TABLE IF EXISTS "public"."machine_port_media_address";
CREATE TABLE "public"."machine_port_media_address" (
...
WITH (OIDS=FALSE);
ALTER TABLE "public"."machine_port_media_address" OWNER TO "postgres";
...
ALTER SEQUENCE "public"."ip_floating_id_seq" RESTART 2 OWNED BY "ip_floating"."id";
...
ALTER SEQUENCE "public"."machine_part_type_id_seq" RESTART 6 OWNED BY "machine_part_type"."id";
ALTER SEQUENCE "public"."machine_port_media_address_id_seq" RESTART 2 OWNED BY "machine_port_media_address"."id";
ALTER SEQUENCE "public"."machine_port_media_id_seq" RESTART 2 OWNED BY "machine_port_media"."id";
ALTER SEQUENCE "public"."machine_port_media_type_id_seq" RESTART 2 OWNED BY "machine_port_media_type"."id";
ALTER SEQUENCE "public"."machine_port_type_id_seq" RESTART 5 OWNED BY "machine_port_type"."id";
ALTER SEQUENCE "public"."machine_type_class_id_seq" RESTART 8 OWNED BY "machine_type_class"."id";
ALTER SEQUENCE "public"."machine_type_id_seq" RESTART 2 OWNED BY "machine_type"."id";
ALTER SEQUENCE "public"."operation_system_id_seq" RESTART 4 OWNED BY "operation_system"."id";
...
ALTER SEQUENCE "public"."web_site_page_widget_id_seq" RESTART 43 OWNED BY "web_site_page_widget"."id";
ALTER SEQUENCE "public"."web_widget_argument_id_seq" RESTART 4 OWNED BY "web_widget_argument"."id";
ALTER SEQUENCE "public"."web_widget_id_seq" RESTART 42 OWNED BY "web_widget"."id";
...
-- ----------------------------
ALTER TABLE "public"."domain_name" ADD CONSTRAINT "domain_name_name_key" UNIQUE ("name") NOT DEFERRABLE INITIALLY IMMEDIATE;
...
-- ----------------------------
--  Primary key structure for table ip_floating
-- ----------------------------
ALTER TABLE "public"."ip_floating" ADD PRIMARY KEY ("id") NOT DEFERRABLE INITIALLY IMMEDIATE;
...
-- ----------------------------
ALTER TABLE "public"."machine_type" ADD PRIMARY KEY ("id") NOT DEFERRABLE INITIALLY IMMEDIATE;

-- ----------------------------
--  Indexes structure for table machine_type
-- ----------------------------
CREATE UNIQUE INDEX  "machine_type_id_key" ON "public"."machine_type" USING btree("id" "pg_catalog"."int4_ops" ASC NULLS LAST);

-- ----------------------------
--  Primary key structure for table machine_type_class
-- ----------------------------
ALTER TABLE "public"."machine_type_class" ADD PRIMARY KEY ("id") NOT DEFERRABLE INITIALLY IMMEDIATE;

-- ----------------------------
--  Indexes structure for table machine_type_class
-- ----------------------------
CREATE UNIQUE INDEX  "machine_type_class_id_key" ON "public"."machine_type_class" USING btree("id" "pg_catalog"."int4_ops" ASC NULLS LAST);

-- ----------------------------
--  Primary key structure for table operation_system
-- ----------------------------
ALTER TABLE "public"."operation_system" ADD PRIMARY KEY ("id") NOT DEFERRABLE INITIALLY IMMEDIATE;

-- ----------------------------
--  Primary key structure for table operation_system_type
-- ----------------------------
ALTER TABLE "public"."operation_system_type" ADD PRIMARY KEY ("id") NOT DEFERRABLE INITIALLY IMMEDIATE;

-- ----------------------------
--  Indexes structure for table operation_system_type
-- ----------------------------
CREATE UNIQUE INDEX  "operation_system_type_id_key" ON "public"."operation_system_type" USING btree("id" "pg_catalog"."int4_ops" ASC NULLS LAST);
...
-- ----------------------------
--  Primary key structure for table machine_part_type
-- ----------------------------
ALTER TABLE "public"."machine_part_type" ADD PRIMARY KEY ("id") NOT DEFERRABLE INITIALLY IMMEDIATE;
...
-- ----------------------------
--  Primary key structure for table machine_port_media_address
-- ----------------------------
ALTER TABLE "public"."machine_port_media_address" ADD PRIMARY KEY ("id") NOT DEFERRABLE INITIALLY IMMEDIATE;

-- ----------------------------
--  Foreign keys structure for table machine
-- ----------------------------
ALTER TABLE "public"."machine" ADD CONSTRAINT "machine_ip_v4_address_fkey" FOREIGN KEY ("ip_v4_address_id") REFERENCES "public"."ip_v4_address" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "public"."machine" ADD CONSTRAINT "machine_ip_v6_address_id_fkey" FOREIGN KEY ("ip_v6_address_id") REFERENCES "public"."ip_v6_address" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE;
...
ALTER TABLE "public"."machine" ADD CONSTRAINT "machine_machine_type_id_fkey" FOREIGN KEY ("machine_type_id") REFERENCES "public"."machine_type" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE;
...
ALTER TABLE "public"."machine" ADD CONSTRAINT "machine_domain_name_id_fkey" FOREIGN KEY ("domain_name_id") REFERENCES "public"."domain_name" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE;

-- ----------------------------
--  Foreign keys structure for table domain_name
-- ----------------------------
ALTER TABLE "public"."domain_name" ADD CONSTRAINT "domain_name_machine_id_fkey" FOREIGN KEY ("machine_id") REFERENCES "public"."machine" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE;

-- ----------------------------
--  Foreign keys structure for table ip_floating
-- ----------------------------
ALTER TABLE "public"."ip_floating" ADD CONSTRAINT "ip_floating_ip_v4_address_id_fkey" FOREIGN KEY ("ip_v4_address_id") REFERENCES "public"."ip_v4_address" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "public"."ip_floating" ADD CONSTRAINT "ip_floating_ip_v6_address_id_fkey" FOREIGN KEY ("ip_v6_address_id") REFERENCES "public"."ip_v6_address" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "public"."ip_floating" ADD CONSTRAINT "ip_floating_machine_id_fkey" FOREIGN KEY ("machine_id") REFERENCES "public"."machine" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE;
...
-- ----------------------------
--  Foreign keys structure for table machine_type
-- ----------------------------
ALTER TABLE "public"."machine_type" ADD CONSTRAINT "machine_type_machine_type_class_id_fkey" FOREIGN KEY ("machine_type_class_id") REFERENCES "public"."machine_type_class" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE;

-- ----------------------------
--  Foreign keys structure for table operation_system
-- ----------------------------
ALTER TABLE "public"."operation_system" ADD CONSTRAINT "operation_system_operation_system_type_id_fkey" FOREIGN KEY ("operation_system_type_id") REFERENCES "public"."operation_system_type" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE;
