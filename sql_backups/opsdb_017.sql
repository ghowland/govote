...
CREATE SEQUENCE "public"."web_site_page_id_seq" INCREMENT 1 START 22 MAXVALUE 9223372036854775807 MINVALUE 1 CACHE 1;
...
CREATE SEQUENCE "public"."web_site_page_widget_id_seq" INCREMENT 1 START 50 MAXVALUE 9223372036854775807 MINVALUE 1 CACHE 1;
ALTER TABLE "public"."web_site_page_widget_id_seq" OWNER TO "postgres";

-- ----------------------------
--  Sequence structure for web_site_user_group_id_seq
-- ----------------------------
DROP SEQUENCE IF EXISTS "public"."web_site_user_group_id_seq";
CREATE SEQUENCE "public"."web_site_user_group_id_seq" INCREMENT 1 START 2 MAXVALUE 9223372036854775807 MINVALUE 1 CACHE 1;
ALTER TABLE "public"."web_site_user_group_id_seq" OWNER TO "postgres";
...
CREATE SEQUENCE "public"."web_widget_id_seq" INCREMENT 1 START 49 MAXVALUE 9223372036854775807 MINVALUE 1 CACHE 1;
...
-- ----------------------------
BEGIN;
INSERT INTO "public"."web_site" VALUES ('1', 'OpsDB', '1', null, null, 't', null);
COMMIT;
...
INSERT INTO "public"."datasource_query" VALUES ('15', '1', 'Wish IPv4 Single Network', 'SELECT ip_v4_network.*, ip_v4_address.address, location.alias FROM ip_v4_network JOIN ip_v4_address ON ip_v4_address.id = ip_v4_address_id JOIN location ON location.id = location_id WHERE ip_v4_network.id = 11', '["id"]', null);
COMMIT;
...
CREATE TABLE "public"."web_user_session" (
	...
	"name" varchar(512) NOT NULL COLLATE "default",
	"json_data" text COLLATE "default",
	"user_id" int8,
...
COMMENT ON COLUMN "public"."web_user_session"."name" IS 'This is the session ID, and is unique';
COMMENT ON COLUMN "public"."web_user_session"."user_id" IS 'This is NULL if this is a guest, which may or may not be allowed';
COMMENT ON COLUMN "public"."web_user_session"."web_site_id" IS 'Sessions are tied to a web site.  Each web site has unique sessions, because they are considered different.';

-- ----------------------------
--  Table structure for web_site_user_group
-- ----------------------------
DROP TABLE IF EXISTS "public"."web_site_user_group";
CREATE TABLE "public"."web_site_user_group" (
	"id" int8 NOT NULL DEFAULT nextval('web_site_user_group_id_seq'::regclass),
	"name" varchar(512) COLLATE "default",
	"web_site_id" int8 NOT NULL,
	"user_group_id" int8range NOT NULL
)
WITH (OIDS=FALSE);
ALTER TABLE "public"."web_site_user_group" OWNER TO "postgres";

COMMENT ON COLUMN "public"."web_site_user_group"."name" IS 'If this is NULL, then use the user_group.name as the group name.  If this isnt NULL, then use this, allowing per web_site customization.';
...
ALTER SEQUENCE "public"."web_site_page_id_seq" RESTART 23 OWNED BY "web_site_page"."id";
ALTER SEQUENCE "public"."web_site_page_widget_id_seq" RESTART 51 OWNED BY "web_site_page_widget"."id";
ALTER SEQUENCE "public"."web_site_user_group_id_seq" RESTART 3 OWNED BY "web_site_user_group"."id";
...
ALTER SEQUENCE "public"."web_widget_id_seq" RESTART 50 OWNED BY "web_widget"."id";
...
-- ----------------------------
ALTER TABLE "public"."web_user_session" ADD CONSTRAINT "web_user_session_name_key" UNIQUE ("name") NOT DEFERRABLE INITIALLY IMMEDIATE;

-- ----------------------------
--  Primary key structure for table web_site_user_group
-- ----------------------------
ALTER TABLE "public"."web_site_user_group" ADD PRIMARY KEY ("id") NOT DEFERRABLE INITIALLY IMMEDIATE;
