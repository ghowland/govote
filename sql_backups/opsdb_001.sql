...
CREATE SEQUENCE "public"."udn_function_id_seq" INCREMENT 1 START 26 MAXVALUE 9223372036854775807 MINVALUE 1 CACHE 1;
...
ALTER SEQUENCE "public"."udn_function_id_seq" RESTART 27 OWNED BY "udn_function"."id";
